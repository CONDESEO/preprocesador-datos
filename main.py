...
def main():
    ...
    while True:
        ...
        if dataset is not None:
            ...
            print(f"  [✗] 2.5 Detección y manejo de valores atípicos (requiere normalización)" if not normalizacion_completada else "  [-] 2.5 Detección y manejo de valores atípicos (pendiente)")
        else:
